...
bin/HCopy -C cfg/hcopy_sph_75.cfg $3_nosil.wav $3.mfc
...
bin/NormFeat --config cfg/NormFeat_energy_HTK.cfg --inputFeatureFilename data/train.lst --featureFilesPath data/prm/ >> log/tmp.log

bin/EnergyDetector  --config cfg/EnergyDetector_HTK.cfg --inputFeatureFilename data/train.lst --featureFilesPath data/prm/  --labelFilesPath  data/lbl/ >> log/tmp.log

bin/NormFeat --config cfg/NormFeat_HTK.cfg --inputFeatureFilename data/train.lst --featureFilesPath  data/prm/   --labelFilesPath  data/lbl/ >> log/tmp.log
